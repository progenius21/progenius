<template>
  <!-- prettier-ignore -->
  <section id="about_b" class="w-full h-screen bg-black overflow-hidden py-32 px-5 lg:px-32 bg-gif flex flex-col lg:flex-row justify-between items-center text-white">
