  ...
  <section id="home" class="w-full min-h-screen overflow-hidden py-32 px-5 lg:px-32 bg-gif flex flex-col lg:flex-row justify-between items-center">
    <div class="prose lg:prose-xl prose-invert z-10 mt-16 lg:mt-32 ">
      ...
      <div class="actions flex gap-5 mt-16" :class="{'animate__animated animate__fadeInDown animate__delay-1s animate__fast': !$route.hash}">
        <button class="px-5 md:px-10 py-3 flex gap-5 items-center justify-between rounded-full transition bg-indigo-700 hover:bg-indigo-500 text-white font-bold">
          <!-- prettier-ignore -->
    ...
    <div class="h-full flex items-end to-btm" >
      <div class="block md:hidden xl:block" :class="{'animate__animated animate__fadeInDown animate__delay-2s animate__fast': !$route.hash}">
