<template>
  ...
  <section id="home" class="w-full h-screen overflow-hidden py-32 px-5 lg:px-32 bg-gif flex flex-col lg:flex-row justify-between items-center">
    <div class="prose lg:prose-xl prose-invert z-10 mt-32">
      <h1>Introducing Web3.0, Simply.</h1>
      ...
      <div class="actions flex gap-5 mt-16">
        <button class="py-3 px-10 flex gap-5 items-center justify-between rounded-full transition bg-indigo-700 hover:bg-indigo-500 text-white font-bold">
          <!-- prettier-ignore -->
        ...
        <nuxt-link to="#about" class="py-5 px-10 flex gap-5 items-center justify-between rounded-full transition-all bg-transparent text-gray-200 hover:text-white font-bold no-underline	">Learn more</nuxt-link>
      </div>
      <!-- End Actions -->
    </div>
    <div class="lg:h-full flex items-end">
      <div>
