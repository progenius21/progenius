<template>
  <!-- prettier-ignore -->
  <section id="about_c" class="w-full min-h-screen overflow-hidden px-5 lg:px-32 block xl:flex items-center justify-between text-dark relative" style="background-color:#fbfcf4">
