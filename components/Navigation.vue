<template>
  ...
  <header class="w-full z-30 p-5 flex justify-between items-center lg:pl-32 lg:pr-20" :class="{'flex-row-reverse lg:flex-row': !showLogo}">
    ...
    <a href="http://community.progenius.io" class="hidden lg:flex py-3 px-10  gap-5 items-center justify-between rounded-full transition bg-indigo-700 hover:bg-indigo-500 text-white font-bold">
